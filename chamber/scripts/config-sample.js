...
window.chamberConfig = {
  ...
  footer: {
    ...
    socialLinks: [
      {
        href: "https://www.facebook.com/yourchamber",
        label: "Facebook",
        icon: "facebook-f",
      },
      {
        href: "https://www.twitter.com/yourchamber",
        label: "Twitter",
        icon: "twitter",
      },
      {
        href: "https://www.instagram.com/yourchamber",
        label: "Instagram",
        icon: "instagram",
      },
      {
        href: "https://www.linkedin.com/company/yourchamber",
        label: "LinkedIn",
        icon: "linkedin-in",
      },
      // You can add more social media platforms
      {
        href: "https://www.youtube.com/channel/yourchamber",
        label: "YouTube",
        icon: "youtube",
      },
    ],
