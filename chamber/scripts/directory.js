document.addEventListener('DOMContentLoaded', function() {
    ...
    function createMemberCard(member) {
        ...
        if (membershipConfig && member.membershipLevel && member.membershipLevel > 0) {
        ...
        if (member.phone) {
          ...
          if (member.website) {
            ...
            website.innerHTML = `Website: <a href="${member.website}" target="_blank">${new URL(member.website).hostname}</a>`;
    ...
    function sortMembers(members, sortBy) {
        ...
        switch(sortBy) {
            ...
            case 'name-desc':
                ...
                break;
            case 'membership':
                sortedMembers.sort((a, b) => (b.membershipLevel || 0) - (a.membershipLevel || 0));
                break;
            case 'membership-desc':
                sortedMembers.sort((a, b) => (a.membershipLevel || 0) - (b.membershipLevel || 0));
                break;
            default:
                break;
        }
