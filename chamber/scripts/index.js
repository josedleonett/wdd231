document.addEventListener('DOMContentLoaded', function() {
    ...
    async function initializeWeather() {
        const weatherConfig = window.chamberConfig?.weather;
    ...
    function displayWeatherFromAPI(current, forecast) {
    ...
    function displayStaticWeather() {
        ...
        const cityName = weatherConfig?.displayCityName || window.chamberConfig?.header?.titleHighlight || "Córdoba, Argentina";
    ...
    async function initializeMemberSpotlight() {
        try {
    ...
    function displayMemberSpotlight(members) {
        const spotlightConfig = window.chamberConfig?.memberSpotlight;
    ...
    function displayStaticSpotlight() {
        const spotlightContainer = document.querySelector('.spotlight-container');
        if (!spotlightContainer) return;
        const spotlightConfig = window.chamberConfig?.memberSpotlight;
